...
cp -r /scratch-shared/njagergallego/data/lvl4_labeled_normalized "$TMPDIR"/dataset_lvl3
...
python -m src.training_scripts.supervised.ablationstudy1_samplingcategories_fabersampling \
    --split 1 \
    --workers 8 \
    --patience 10001 \
